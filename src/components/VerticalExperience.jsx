          ...
          <div className="flex flex-col gap-12">
            {experience.map((item, index) => (
              ...
              >
                ...
                <div className="absolute -left-[30px] sm:-left-[39px] top-6 flex h-6 w-6 items-center justify-center rounded-full border border-violet bg-ink shadow-lg shadow-violet/20 group-hover:scale-125 transition-transform">
