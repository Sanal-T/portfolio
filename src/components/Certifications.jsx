      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {certifications.map((cert, index) => (
            ...
            >
              <StarBorder color="#06b6d4" speed="6s" borderRadius={16} className="h-full">
                <div className="bento-tile flex flex-col justify-between p-6 hover:border-violet/40 transition-all duration-300 group h-full">
                  <div>
